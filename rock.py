...
class Rock(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Rock Page", font=LARGE_FONT)
    ...
    def add_song(self):
        song = filedialog.askopenfilename(initialdir='music/Rock/', title='Select Song',
                                          filetypes=(("mp3 Files", "*.mp3"),))
        print(song)
        song = song.replace('C:/Users/adria/PycharmProjects/GUI Project/music/Rock/', "")
    ...
    def start_song(self):
        ...
        song = f'C:/Users/adria/PycharmProjects/GUI Project/music/Rock/{song}.mp3'
